  ...
  return (
    <div className="about">
      <div className="container">
        <h2>About PremiumRetail</h2>
        
        <div className="about-content">
          <div className="about-text">
            <p>
              Welcome to PremiumRetail, your premier destination for high-quality products across various categories. 
              We're committed to providing our customers with an exceptional shopping experience, offering carefully 
              curated products that meet the highest standards of quality and value.
            </p>
            
            <p>
              Founded in 2023, our mission has always been to make premium products accessible to everyone. 
              We carefully select each item in our inventory, ensuring that it meets our strict quality guidelines 
              and offers genuine value to our customers.
            </p>
            ...
            <h3>Why Choose Us?</h3>
            <p>
              With thousands of satisfied customers and a growing collection of premium products, 
